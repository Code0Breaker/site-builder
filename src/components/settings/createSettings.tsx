...
export const CreateSettingsDialog = ({open, setOpen}:{open:boolean, setOpen:(state:boolean)=>void}) =>{
    ...
    return(
      ...
      >
        ...
        <DialogContent sx={{display:'flex',gap:3, flexDirection:'column'}}>
          <OutlinedInput fullWidth placeholder="Key" value={user.key} onChange={e=>setUser({...user, key:e.target.value})}/>
          <OutlinedInput fullWidth placeholder="Content en" value={user.content_en} onChange={e=>setUser({...user, content_en:e.target.value})}/>
          <OutlinedInput fullWidth placeholder="Content ru" value={user.content_ru} onChange={e=>setUser({...user, content_ru:e.target.value})}/>
        </DialogContent>
        <DialogActions>
