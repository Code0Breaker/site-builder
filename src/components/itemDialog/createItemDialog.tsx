...
export const ItemDialog = ({open, setOpen}:{open:boolean, setOpen:(state:boolean)=>void}) =>{
        ...
        <Dialog
            ...
            >
              ...
              <DialogContent sx={{display:'flex',gap:3, flexDirection:'column'}}>
                ...
                <textarea style={{width:'100%', height:200}} placeholder="content" value={item.content} onChange={e=>setItem({...item, content:e.target.value})}/>
